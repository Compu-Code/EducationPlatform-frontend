    ...
    <transition name="acc-dropdown">
      ...
      >
        <div class="py-4 px-[0.625rem]">
          <div class="mb-3 flex w-full px-[0.938rem] items-center justify-start">
